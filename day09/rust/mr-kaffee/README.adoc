...
*Step 3*: define for part 3 of the puzzle a function which finds a contiguous range summing up to a given value and returns the sum of the smallest and largest number in that range:
