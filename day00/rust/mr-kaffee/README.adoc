...
All days should run using `cargo run`. I also plan to add some simple tests based on the example data from the puzzle descriptions which can be executed using `cargo test`.
